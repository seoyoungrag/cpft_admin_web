package kr.co.teamfresh.cpft.admin.web.backend.controller.baroservice;
...
public class BrokerParty {
	...
	@ApiModelProperty(value = "corpName", example="(주)팀프레시", required = true)
	String corpName; // 회사명 //특수문자 사용 불가 ex. 특수문자 중 1 byte '㈜' 는 '(주)'로 입력
	@ApiModelProperty(value = "ceoName", example="이성일", required = true)
	String ceoName; //대표자명
	...
	String tel; //휴대폰
	@ApiModelProperty(value = "email", example="youngrag.seo@timf.co.kr", required = true)
	String email; //이메일
}
